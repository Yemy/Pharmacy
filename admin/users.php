                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">                                    
                                    <h4 class="card-title"><a href="adduser" class="btn btn-primary "><i class="la la-plus"></i> Add New</a>&nbsp;<a href="roles" class="btn btn-primary "><i class="la la-eye"></i> Roles</a></h4>
                                            ...
                                            <table class="table table-striped table-bordered dom-jQuery-events">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?=$group['name']?></td>
                                                        <td>
                                                            <a title="Edit" href="edituser?id=<?=$value['id']?>" class="btn btn-icon btn-primary mr-1 mb-1"><i class="la la-edit"></i></a>
