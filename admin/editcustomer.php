...
$stmt = $conn->prepare("SELECT * FROM customers WHERE id='".$_GET['id']."'");
$stmt->execute();
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form-horizontal" action="app/customers" method="post" enctype="multipart/form-data" novalidate>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6 col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="text" name="name" class="form-control mb-1" value="<?=$result['name']?>" required data-validation-required-message="Customer name is required">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                ...
                                                <div class="col-lg-6 col-md-12">
                                                    ...
                                                    <div class="text-right">
                                                        ...
                                                        <a href="customers" class="btn btn-danger">Cancel <i class="la la-close position-right"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
